...
import favoritos from "../Context/FavoritosContext"
import "./index.css"
const Index = () => {
  return (
    <>
            ...
            <footer>
                <form className="colorful-form">
                    <div className="form-group">
                        ...
                        <input required="" placeholder="Email" className="form-input" name="email" id="email" type="email" />
                    </div>
                    <div className="form-group">
                        <label className="form-label" for="message">Mensaje:</label>
                        <textarea required="" placeholder="Mensaje" className="form-input" name="message" id="message"></textarea>
                    </div>
                    <button className="form-button" type="submit">Enviar</button>
                </form>
                <div class="social-buttons">
                    <a href="https://github.com/tamischnaiderman1" class="social-button github">
                    ...
                    <a href="https://www.linkedin.com/in/tami-schnaiderman-a99000298/" class="social-button linkedin">
                    ...
                    <a href="https://www.instagram.com/tami.schnai/" class="social-button instagram">
